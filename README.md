...
This pop-up modal should pop-out at the click of a `Escape` button and `clicking outside` of the pop-up modal.

And I performed this with the help of `addEventListener` ,`mousedown` ,`keypress` .